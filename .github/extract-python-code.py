...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python extract_python_code.py <path_to_markdown_file> [<additional_paths_to_markdown_files>...]")
        sys.exit(1)
    ...
    for file_path in sys.argv[1:]:
        try:
            ...
            print(f"Python code has been extracted and saved to '{output_file}' from '{file_path}'.")
