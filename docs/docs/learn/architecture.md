...
For example: "Log into my account and change my username to The WaveHunter."
...
For example: "Locate the username input field and enter the text 'user123'."
...
<img src="../../assets/research.png" alt="Yann LeCun's proposed architecture for AI" width="80%">
