    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            if (err instanceof Event && err.target instanceof WebSocket) {
                setError('Unable to connect. Please ensure that the host is valid and points to an active driver server / an instance of lavague-serve running. More instructions on https://docs.lavague.ai/.');
            } else {
